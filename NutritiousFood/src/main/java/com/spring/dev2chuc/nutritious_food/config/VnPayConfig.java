...
public class VnPayConfig {
    ...
    public static String vnp_Returnurl = "http://anlanhmanh.com/payment";
    public static String vnp_TmnCode = "08VL26ZI";
    public static String vnp_HashSecret = "UWYJZYOTTGSGOPFQAMDGXAVGRDYNTSUP";
